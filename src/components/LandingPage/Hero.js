      ...
      <div className="container pt-16 pt-md-18 pb-9">
        <div className="row gx-0 gy-10 align-items-center text-center text-lg-start">
          <div className="col-lg-6 col-xxl-5 position-relative" data-cues="slideInDown" data-group="page-title" data-delay="400">
            ...
            <div className="d-flex justify-content-center justify-content-lg-start" data-cue="slideInDown" data-group="page-title-buttons" data-delay="500">
              <span>
                <a href="#">
                  <img 
          ...
          <div className="col-lg-6 ms-auto mb-n20 mb-xxl-n22"  data-cue="fadeIn" 
              data-delay="3000" >
            <figure>
              <Image 
                src="/assets/img/hero/device_hero.png" 
                srcSet="/assets/img/hero/device_hero@2x.png 2x" 
                alt="Devices" 
                width={500} 
                height={500} 
              />
